...
\textit{Analyze the data to describe the effect of El Nino on (a) the number of tropical storms, (b) the number of hurricanes, and (c) the storm index after accounting for the effects of West African wetness and for any time trends, if appropriate.} \todo{Problem 6}
...
\part \textit{the storm index} \label{prob:1028a}
